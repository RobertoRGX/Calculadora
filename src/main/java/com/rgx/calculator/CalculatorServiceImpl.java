...
public class CalculatorServiceImpl implements CalculatorService {
	...
	public String suma(String val1,String val2) {
		...
		log.debug("La suma de "+val1+" y "+val2+" es: "+ res);
		return "La suma de "+val1+" y "+val2+" es: "+ res;
	...
	public String resta(String val1,String val2) {	
		try {
		double res = Double.parseDouble(val1)-Double.valueOf(val2);
		log.debug("La resta de "+val1+" y "+val2+" es: "+ res);
		return "La resta de "+val1+" y "+val2+" es: "+ res;
	}catch (NumberFormatException e) {
	...
	public String multi(String val1,String val2) {
		try {
		double res = Double.parseDouble(val1)*Double.valueOf(val2);
		log.debug("El producto de "+val1+" y "+val2+" es: "+ res);
		return "El producto de "+val1+" y "+val2+" es: "+ res;
		}catch (NumberFormatException e) {
	...
	public String divide(String val1,String val2) {	
		try {
			double res = Double.parseDouble(val1)/Double.valueOf(val2);
			log.debug("La division de "+val1+" y "+val2+" es: "+ res);
			return "La division de "+val1+" y "+val2+" es: "+ res;
		}catch (NumberFormatException e) {
